/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/contact/wrangler.jsonc workers/contact/worker-configuration.d.ts` (hash: dce79abadc91585264bdd61fd2f52eaf)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONTACT_RECIPIENT" | "CONTACT_SENDER" | "ALLOWED_ORIGINS" | "ALLOWED_HOSTNAMES" | "TURNSTILE_ACTION" | "SUCCESS_URL" | "CONTACT_URL" | "TURNSTILE_SECRET_KEY">> {}
}
